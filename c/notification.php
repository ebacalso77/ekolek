                        ...
                        <div class="col-lg-12" >
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-center my-3">
                                    <h4 class="text-gray-900 " style="font-weight: bolder;">Notification</h4>
                                </div>
                                <?php
                                $get_notif=mysqli_query($con,"select * from tbl_notification where user_id='".$_SESSION['user_id']."' order by notif_date DESC");
