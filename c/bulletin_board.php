...
FROM
    tbl_bulletin
INNER JOIN tbl_user ON tbl_bulletin.posted_by = tbl_user.user_id  where user_type='3' or user_type='1'
                                                    ...
                                                    <div class="card border-left-secondary shadow h-100 py-1">
                                                        <div class="card-body">
                                                            <div class="row no-gutters align-items-center">
                                                                <div class="col mr-2">
                                                                    <div class="p font-weight-bold text-primary"><?=ucfirst($b['fname']." ".$b['mname']." ".$b['lname'])?> |<small class="mx-1">
                                                                            <?php
                                                                            if ($b['user_type']=="1"){
                                                                                echo "Admin";
                                                                            }else{
                                                                    ...
                                                                    <div class="p font-weight-bold text-gray "><span class="text-dark" style="font-size: 14px;"><?=$b['time_difference']?></span> .<i class="fa fa-globe-asia mx-1"></i></div>
                                                                </div>
                                                                <div class="row mx-1 my-1">
                                                                    <p class="text-wrap text-justify" style="font-size: 15px"><?=base64_decode($b['b_message'])?>
                                                                        ...
                                                                        if ($b['user_type']=="3"){
                                                                        ?>
                                                                    <br><span class="text-dark" style="font-size: 13px;">
                                                                            Schedule Collection Details: <strong><?=date("D d M, Y",strtotime($b['date_pass']))?> Around <?=date("h:i:s A",strtotime($b['time_from']))?> to <?=date("h:i:s A",strtotime($b['time_to']))?> at Brgy.
                                                                            <?php
