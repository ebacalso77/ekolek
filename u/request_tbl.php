                    ...
                    <div class="row">
                        <div class="col-lg-12" >
                            ...
                            <div class="p-4">
                                ...
                                <div class="text-left">
                                    <a class="text-decoration-none text-dark" href="user_request.php" ><i class="fa fa-arrow-left fa-lg"></i></a>
                                </div>
                                ...
                                <div class="text-center my-3">
                                    <h4 class="text-gray-900 " style="font-weight: bolder;">My Request</h4>
                                </div>
                                <div class="table" style="font-size: small">
                                    <table id="example" class="display table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                        $request=mysqli_query($con," SELECT tbl_user.*,tbl_request.* FROM `tbl_request`inner join tbl_user on tbl_request.r_user_id=tbl_user.user_id  where r_user_id='".$_SESSION['user_id']."' order by date_posted DESC");
                                                    ...
                                                    <td class="text-wrap text-center">
                                                        <?php
                                                            if ($r['r_status']=="approved"){
                                                                echo '<span class="text-secondary" style="font-size: 30px"><i class="fa fa-thumbs-up" ></i></span><br><small>Approved By Admin</small>';
                                                            }
