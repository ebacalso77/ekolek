...
if (isset($_POST['register'])){
    ...
    if(mysqli_num_rows($select_email)>0){
        ...
        $insert=mysqli_query($con,"INSERT INTO `tbl_user` ( `username`, `password`, `email`, `fname`, `mname`, `lname`, `user_type`, `user_m_id`) VALUES ( '$username', '$encrypPass', '$email', '$fname', '$mname', '$lname', '1', '$municipality')");
        if ($insert){
            echo '<script>alert("Successfully created your account.");window.open("index.php","_self");</script>';
        }else{
                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Administrator Account <br> Registration!</h1>
                        </div>
                        <hr>
