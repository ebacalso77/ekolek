                            ...
                            <div class="p-5">
                                ...
                                <form method="post" action="">
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" placeholder="Enter Email Address..." name="email" autofocus>
                                    </div>
                                    <button type="submit" class="btn btn-primary btn-block"  name="recover" onclick="show()"> Submit</button>
                                </form>
                                <hr>
                                <div class="text-center">
